<template>
    <div>
        <inertia-link :as="isHas?'span':'a'" :class="{'hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700':!isHas,'bg-gray-200 dark:bg-gray-700 dark:text-gray-200 text-gray-700':Number($page.props.menuId)===model.id}"
           class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 "
                      :href="isHas?'#':route('contents.handleContent',model.id)">
