<nav class="bg-white shadow dark:bg-gray-800">
    ...
    <div class="container px-6 py-4 mx-auto lg:flex lg:justify-between lg:items-center">
        <div class="lg:flex lg:items-center">
            ...
            <div class=" clearfix father-ul flex flex-col  text-gray-600 capitalize dark:text-gray-300 lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">

                <li class="list-none ">
                    <a class="mt-2 relative   lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200" href="">home</a>
                    <div class="drop-div" >
                        <span class="trangle"></span>
                        <ul class="child-ul absolute z-20 w-48 py-2  bg-white rounded-md shadow-xl dark:bg-gray-800">
                            <li >
                                <a class="block px-4 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-blue-500 hover:text-white dark:hover:text-white" href="">vue.js</a>
                            </li>
                        </ul>
                    </div>
                </li>

                <a href="#" class="mt-2 relative   lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200">features
